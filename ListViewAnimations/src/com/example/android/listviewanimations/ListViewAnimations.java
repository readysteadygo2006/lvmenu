        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, final View view, int position, long id) {
                final String item = (String) parent.getItemAtPosition(position);
                    ...
                    // content.
                	AnimatorSet icon = new AnimatorSet();
                    ObjectAnimator animY = ObjectAnimator.ofFloat(view, View.SCALE_Y, 10);
                    ObjectAnimator animX = ObjectAnimator.ofFloat(view, View.SCALE_X, 10);
                    icon.play(animX).with(animY);
                    ...
                    icon.addListener(new AnimatorListenerAdapter() {
                        @Override
